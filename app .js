// ── CONFIGURACIÓN ────────────────────────────
const SUPABASE_URL = 'https://ckcqupvcejxfemdfuiid.supabase.co';
const SUPABASE_KEY = 'sb_publishable_6ESFOcHUnWjXwgriIyUM5w_jsqwvryo';
const TABLA        = 'Lugares';
...
async function guardarLugar() {
  ...
  const fecha = new Date().toISOString().split('T')[0]; // "2026-03-18"
